...
The governed API is the durable source of truth for tax-return preparation. Only the versioned support matrix is accepted. A credentialed preparer must review calculations, uncertain positions, signatures, and filing. This system does not provide tax advice. Generated backlog endpoints are disabled by default and cannot be enabled in production.
